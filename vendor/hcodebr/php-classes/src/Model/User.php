<?php
    ...
    class User extends Model
    {
        ...
        public function save()
        {
            ...
            $results = $sql->select("CALL sp_users_saved(:desperson, :deslogin, :despassword, :desemail, :nrphone, :inadmin)", array(
        ...
        public static function getForgot($email)
        {
			...
			$results2 = $sql->select("CALL sp_userspasswordsrecoveries_create(:iduser, :desip)", array(
                ...
                else
                {
                    ...
                    $mailer = new Mailer($data["desemail"],$data["desperson"], "Redefinição do HCODE Store","forgot",
                    array(
                        "name"=>$data["desperson"],
                        "link"=>$link
                    ));
        ...
        public static function validForgotDecrypt($code)
        {
            ...
            tb_users b USING(iduser) INNER JOIN tb_persons c USING (idperson)
